	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          <li class="nav-item"><a href="http://localhost/hotel_booking_form/index.php" class="nav-link"><span class="blue-text font-weight-bold">HOME</span></a></li>
...
<h3 class="h3-responsive text-center font-weight-bold p-5">HOTELS</h3>
